...
from .type_annotation import ClassDecorator, ClassWithLogger, UserClass


__all__ = ["add_logger"]


def add_logger(name: str | None = None) -> ClassDecorator:
    """Add logger to class.
    ...
    def decorator(cls: UserClass) -> ClassWithLogger:
        ...
        class Wrapper(cls):
            ...
            def __init__(self: ClassWithLogger, *args, **kwargs) -> None:
